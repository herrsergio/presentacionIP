...
window.slidesConfig = window.slidesConfig || {
  ...
  info: {
    // Presentation Name
    title: 'Desarrollo para la mejora de los procesos operativos en los restaurantes de Premium Restaurant Brands',
    subtitle: 'Informe de Trabajo Profesional',

    // Personal info
    name: 'Sergio Cuéllar Valdés',
